...
inline bool
Ui2AllocateInstrumentTable(const Ui2InstrumentParameterDescriptor &descriptor,
                           Variable &value, TableHolder &tables) {
  const bool tableField = descriptor.primary == FourCC::SampleInstrumentTable ||
